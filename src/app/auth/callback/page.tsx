  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center max-w-md mx-auto px-4">
        ...
        <p className="text-gray-600 mb-6">
          You have successfully connected your YNAB account. 
        ...
        <div className="space-y-3">
          ...
          <div className="bg-green-50 border border-green-200 rounded-md p-4">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-green-800">Secure Connection Established</h3>
                <p className="mt-1 text-sm text-green-700">
                  Your YNAB data is now accessible for analysis. Your session will remain active for up to 2 hours.
                </p>
              </div>
            </div>
          </div>
