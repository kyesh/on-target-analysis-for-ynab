...
const ERROR_TYPES: Record<string, ErrorInfo> = {
  access_denied: {
    ...
    description:
      'To use this application, you need to grant access to your YNAB data. This allows us to analyze your budget targets and spending patterns.',
  },
  invalid_request: {
    type: 'Invalid Request',
    message: 'The authentication request was invalid',
    description:
      'There was a problem with the authentication request. This might be a temporary issue.',
  },
  unauthorized_client: {
    type: 'Unauthorized Client',
    message: 'This application is not authorized',
    description:
      'The application is not properly configured for YNAB OAuth. Please contact support.',
  },
  unsupported_response_type: {
    type: 'Unsupported Response Type',
    message: 'The authentication method is not supported',
    description:
      'The requested authentication method is not supported by YNAB.',
  },
  invalid_scope: {
    type: 'Invalid Scope',
  ...
  server_error: {
    ...
    description:
      "There was a temporary problem with YNAB's servers. Please try again in a few minutes.",
  },
  temporarily_unavailable: {
    type: 'Service Unavailable',
    message: 'YNAB service is temporarily unavailable',
    description:
      "YNAB's authentication service is temporarily unavailable. Please try again later.",
  },
  configuration_error: {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <div
            className={`mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-${errorColor}-100 mb-4`}
          >
            {getErrorIcon()}
          </div>
          ...
          <p className="mb-4 text-gray-600">{errorInfo.message}</p>
        ...
        <div className="space-y-4">
          <button
            onClick={handleRetry}
            className="w-full rounded-md bg-blue-600 px-4 py-3 font-medium text-white transition-colors duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Try Again
          </button>
          ...
          <button
            ...
            className="w-full rounded-md bg-gray-200 px-4 py-3 font-medium text-gray-800 transition-colors duration-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
          >
            Go to Home Page
          </button>
        </div>
        ...
        {/* Help Information */}
        <div
          className={`bg-${errorColor}-50 border border-${errorColor}-200 rounded-md p-4`}
        >
          <div className="flex">
